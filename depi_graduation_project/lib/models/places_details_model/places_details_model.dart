...
class PlacesDetailsModel {
  ...
  int? utcOffset;
  String? vicinity;
  String? editorialSummary; // الوصف القصير
  double? rating; // تقييم المكان
  bool? openNow; // مفتوح الآن أو لا
  ...
  factory PlacesDetailsModel.fromJson(Map<String, dynamic> json) {
    return PlacesDetailsModel(
      ...
      editorialSummary: json['editorial_summary']?['overview'] as String?,
  ...
  Map<String, dynamic> toJson() => {
    ...
    'vicinity': vicinity,
    'editorial_summary': {'overview': editorialSummary},
    'rating': rating,
